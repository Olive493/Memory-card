...
Question("Миша", "mouse", "mice", "mashed", "job"),
Question("Морква", "carrot", "carry", "cut", "cool"),
Question("Хмара", "cloud", "clown", "circus", "cat")
]
...
def menu_generation():
    ...
    text=(f"Разів відповідали: {Question.count_ans}\n"\
